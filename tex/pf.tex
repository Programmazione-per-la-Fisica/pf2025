% Copyright 2019-2025 Istituto Nazionale di Fisica Nucleare (INFN)
...
\hypersetup{pdftitle=Programmazione per la Fisica -- 2025/2026}
...
\date{Corso di laurea in Fisica, Università di Bologna, 2025/2026}
...

{
  ...
  \begin{frame}[plain,noframenumbering]
    \begin{tikzpicture}[remember picture,overlay]
      ...
      \node (virtuale-mz) at ([yshift=.1cm]git.north) {\tiny\url{https://virtuale.unibo.it/course/view.php?id=74839} (M-Z)};
      \node (virtuale-al) at ([yshift=.1cm]virtuale-mz.north) {\tiny\url{https://virtuale.unibo.it/course/view.php?id=76078} (A-L)};
    \end{tikzpicture}
    \titlepage
  \end{frame}
}
