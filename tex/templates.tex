...
class Complex \{
 ...
 public:
  ...
  \alert{double} real() const \{ return r_; \}
  \alert{double} imag() const \{ return i_; \}
\};}\end{codeblock}
...
class Complex \{
 ...
 public:
  ...
  \alert{float} real() const \{ return r_; \}
  \alert{float} imag() const \{ return i_; \}
\};}\end{codeblock}
...
class Complex \{
  ...
  \alert{FP} i_;
 public:
  Complex(\alert{FP} x = \alert{FP}\{\}, \alert{FP} y = \alert{FP}\{\}) : r_\{x\}, i_\{y\} \{\}
  \alert{FP} real() const \{ return r_; \}
  \alert{FP} imag() const \{ return i_; \}
\};
